import { Pressable, StyleSheet, Text, View, ImageBackground, TouchableOpacity, Modal } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            <ImageBackground
                ...
                <Text style={styles.welcome_text}> Bienvenido {nombre} {apellido} </Text>
            </ImageBackground>
            ...
            <View style={styles.fast_access}>
                ...
                <View style={styles.fast_access_buttons}>
                    <View style={{ alignItems: "center" }}>
                        <Pressable style={styles.circular_button} onPress={() => navigateTo("home")}>
                    ...
                    <View style={{ alignItems: "center" }}>
                        <Pressable style={styles.circular_button} onPress={() => navigateTo("Protocol1")}>
                    ...
                    <View style={{ alignItems: "center" }}>
                        <Pressable style={styles.circular_button} onPress={() => navigateTo("Protocol2")}>
            ...
            <Modal style={styles.container} visible={dropdownVisible}>
                ...
                <View style={[styles.container, { backgroundColor: '#275DAD', padding: 20 }]}>
                    <TouchableOpacity style={styles.button} onPress={toggleDropdown}>
                        <Text style={[{ fontSize: 30 }, styles.box_text]}>Volver</Text>
                    </TouchableOpacity>
                    <View style={styles.fast_access_buttons}>
                        <View style={{ alignItems: "center" }}>
                            <Pressable style={[styles.circular_button, { backgroundColor: "white" }]} onPress={() => navigateToWithDropdown("Protocol1")}>
                                <Text style={[styles.button_text, { color: "#275DAD" }]}> 1 </Text>
                            </Pressable>
                            <Text style={{ fontSize: 12 }}> Protocolo 1 </Text>
                        </View>
                        <View style={{ alignItems: "center" }}>
                            <Pressable style={[styles.circular_button, { backgroundColor: "white" }]} onPress={() => navigateToWithDropdown("Protocol2")}>
                                <Text style={[styles.button_text, { color: "#275DAD" }]}> 2 </Text>
                            </Pressable>
                            <Text style={{ fontSize: 12 }}> Protocolo 2 </Text>
                        </View>
                        <View style={{ alignItems: "center" }}>
                            <Pressable style={[styles.circular_button, { backgroundColor: "white" }]} onPress={() => navigateToWithDropdown("Protocol3")}>
                                <Text style={[styles.button_text, { color: "#275DAD" }]}> 3 </Text>
                            </Pressable>
                            <Text style={{ fontSize: 12 }}> Protocolo 1 </Text>
                        </View>
                        <View style={{ alignItems: "center" }}>
                            <Pressable style={[styles.circular_button, { backgroundColor: "white" }]} onPress={() => navigateToWithDropdown("Protocol4")}>
                                <Text style={[styles.button_text, { color: "#275DAD" }]}> 4 </Text>
                            </Pressable>
